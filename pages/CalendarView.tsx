...
import { ChevronLeft, ChevronRight, Calendar as CalendarIcon, Warehouse, Clock, CalendarClock, PlayCircle, CheckCircle2, Info, CalendarDays, Container, MapPin, StopCircle, LogOut } from 'lucide-react';
...
export const CalendarView: React.FC = () => {
  ...
  // Display Docks + Virtual "Unassigned" Row
  const dockResources = useMemo(() => {
    const sortedDocks = [...docks].sort((a, b) => a.name.localeCompare(b.name, undefined, { numeric: true, sensitivity: 'base' }));
    // Virtual Row
    const unassignedRow: any = { id: 'unassigned', name: 'Unassigned', type: 'Holding' };
    return [unassignedRow, ...sortedDocks];
  }, [docks]);
            ...
            <div className="min-w-[1200px] flex flex-col min-h-full relative">
              ...
              <div className="sticky top-0 z-40 flex h-20 border-b border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-[#1a1a1a]">
                ...
                <div className="flex-1 flex flex-col relative">
                  {/* Shifts */}
                  <div className="h-10 flex border-b border-slate-200 dark:border-white/5 relative w-full">
